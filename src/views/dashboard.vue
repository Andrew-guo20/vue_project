        ...
        <el-card v-if="aiData.systemOverview">
          <div class="card-content">
            <div class="avatar users">
              <el-image :src="iconUrl1" style="width: 40px; height: 40px;" alt="用户" />
            </div>
            <div class="info">
        ...
        <el-card v-if="aiData.systemOverview">
          <div class="card-content">
            <div class="avatar like">
              <el-image :src="iconUrl2" style="width: 40px; height: 40px;" alt="用户" />
            </div>
            <div class="info">
        ...
        <el-card v-if="aiData.systemOverview">
          <div class="card-content">
            <div class="avatar comments">
              <el-image :src="iconUrl3" style="width: 40px; height: 40px;" alt="用户" />
            </div>
            <div class="info">
        ...
        <el-card v-if="aiData.systemOverview">
          <div class="card-content">
            <div class="avatar smile">
              <el-image :src="iconUrl4" style="width: 40px; height: 40px;" alt="用户" />
            </div>
            <div class="info">
...
const initEmotionChart = () => {
  ...
  console.log(ThendData,'ThendData')
  // 配置项
  const option = {
    // 设置标题
    title: {
