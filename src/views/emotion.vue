<template>
  <div>
    ...
    <el-table :data="tableData" style="width: 100%;">
      ...
      <el-table-column label="情绪触发因素" prop="emotionTriggers" width="120"/>
...
const formItem = [
  { comp:'input',props:'userId',label:'用户ID',placeholder:'请输入用户ID'},
  { comp:'select',props:'moodScoreRange',label:'情绪评分',placeholder:'请选择情绪评分范围',
    options:[
