  ...
  <div class="knowledge-container">
    <div class="header-section">
      <div class="header-content">
        <el-image :src="iconUrl" style="height: 60px; width: 60px;"></el-image>
        <h1>心理健康知识库</h1>
      </div>
    </div>
    <div class="content">
      ...
      <div class="article-list">
        <div class="article-item" v-for="item in articleList" :key="item.id">
          ...
          <div class="info">
            <div class="title">
              <h3>{{ item.title }}</h3>
              <el-tag Piain type="primary">{{ item.categoryName }}</el-tag>
            </div>
...
const iconUrl = new URL('/src/assets/images/book.png', import.meta.url).toString()
